...
_TEXT_KEYWORD_RULES: list[tuple[str, list[str]]] = [
    ...
    (
        r"\bdesign\b.{0,100}\b(?:ai|tool|creative)\b|\bai.{0,100}\bdesign\b",
        ["design-creative"],
    ),
    ...
    (
        r"\btesting\b.{0,100}\bqa\b|\btest automat\b|\bquality assurance\b",
        ["testing-qa"],
    ),
    (r"\bcode review\b", ["code-review"]),
    (r"\bpresentation\b|\bslide(?:s)?\b", ["presentation"]),
    (r"\bemail\b.{0,100}\b(?:ai|assist|generat|automat)\b", ["email"]),
    (
        r"\bsales\b.{0,100}\bcrm\b|\bcrm\b.{0,100}\bsales\b|\bsales (?:assist|automat|tool)\b",
        ["sales-crm"],
    ),
    ...
    (r"\blegal\b.{0,100}\b(?:ai|assist|tool)\b", ["legal-assist"]),
    ...
    # Domain
    (r"\bhealthcare\b|\bmedical\b|\bhealth\b.{0,100}\bai\b", ["healthcare"]),
    (r"\bdrug discover|\bpharma(?:ceut(?:ical)?)?\b", ["drug-discovery"]),
    ...
    (r"\bgaming\b|\bgame\b.{0,100}\bai\b|\bai.{0,100}\bgame\b", ["gaming"]),
    ...
    (
        r"\bautonomous vehicl|\bself.driving\b|\bautonomous driv",
    ...
    (r"\bapi\b.{0,100}\b(?:service|platform|access)\b|\brest api\b", ["api-service"]),
    (r"\bsaas\b", ["saas"]),
    ...
    (
        r"\bmobile app\b|\bios\b.{0,100}\bandroid\b|\bandroid\b.{0,100}\bios\b",
        ["mobile-app"],
    ),
